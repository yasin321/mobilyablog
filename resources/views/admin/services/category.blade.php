                    ...
                    <div class="table-responsive">
                        <table id="dataTableExample" class="table">
                            ...
                            @foreach($categories as $category)
                                <tr>
                                    <td><img src="{{asset($category->photoUrl)}}" style="object-fit: cover;" alt="">
                                    </td>
                                    ...
                                    <td><a href="javascript:void(0);"
                                           onclick="$.servicesCategoryDetail({{$category->id}})">Düzenle</a>
                                        | <a href="{{route("servicesCategoryRemove",$category->id)}}">Sil</a></td>
